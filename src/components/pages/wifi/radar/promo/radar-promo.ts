  ...
  featureList: IPromoFeatureItem[] = [
    ...
    },
    {
      ...
      description: `<ul>
        ...
        <li>Рассказывайте об акциях собранным аудиториям — запускайте коммуникации прямо из личного кабинета, настраивайте таргетированную рекламу в Яндекс, MyTarget.</li>
      </ul>`
    },
    {
      icon: 'pie_diagram',
