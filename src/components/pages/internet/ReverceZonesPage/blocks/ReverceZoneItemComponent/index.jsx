...
export default Vue.extend({
    ...
    render(h) {
        return (<div class={['reverce-zone-item-component', { 'deleted': this.isDeleted }]}>
        <div class={['content', 'main-content', 'main-content--h-padding']}>
          <div class={'ip'}>{this.ip}</div>
          <div class={'reverce-zone'}>
            {!this.isDeleted && (<div class={'caption'}>Обратная зона</div>)}
            <div class={'value'}>
              {this.isDeleted
          ...
          {!this.isDeleted && (<div class={'delete'}>
        ...
        <er-activation-modal type={'question'} title={'Вы уверены, что хотите удалить обратную зону?'} actionButtonText={'Удалить'} vModel={this.isOpenQuestion} onConfirm={this.isDeletedConfirm}>
