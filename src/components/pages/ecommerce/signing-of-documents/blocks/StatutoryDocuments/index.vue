<template lang="pug">
  .e-commerce-statutory-documents
    ...
    .e-commerce-statutory-documents__subtitle.mb--xl
      div В соответствие с требованиями законодательства РФ мы, как оператор связи, обязаны запросить у вас пакет документов!
      div Документы следует загрузить только при первой покупке!
