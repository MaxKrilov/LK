...
export default class SupportIndexPage extends Vue {
  ...
  listCity2 = [
    { caption: 'А', items: ['Ангарск'] },
    { caption: 'Б', items: ['Барнаул', 'Березники', 'Брянск'] },
    { caption: 'В', items: ['Волгоград', 'Волжский', 'Воронеж'] },
    { caption: 'Д', items: ['Дзержинск', 'Димитровград'] },
    { caption: 'Е', items: ['Екатеринбург'] },
    { caption: 'И', items: ['Ижевск', 'Иркутск'] }
  ]
  city = []
  /**
