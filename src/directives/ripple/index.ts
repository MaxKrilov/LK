...
type ErRippleEvent = MouseEvent | TouchEvent | KeyboardEvent
...
const isTouchEvent = (e: ErRippleEvent): e is TouchEvent => e.constructor.name === 'TouchEvent'

const isKeyboardEvent = (e: ErRippleEvent): e is KeyboardEvent => e.constructor.name === 'KeyboardEvent'

const calculate = (e: ErRippleEvent, el: HTMLElement, value: RippleOptions = {}) => {
  let localX = 0
  let localY = 0
...
const ripples = {
  show (e: ErRippleEvent, el: HTMLElement, value: RippleOptions = {}) {
...
const rippleShow = (e: ErRippleEvent) => {
...
const updateRipple = (el: HTMLElement, binding: VNodeDirective, wasEnabled: boolean) => {
...
const directive = (el: HTMLElement, binding: VNodeDirective, node: VNode) => {
...
const update = (el: HTMLElement, binding: VNodeDirective) => {
