...
const createHandlers = (value: TouchHandlers): TouchStoredHandlers => {
  const wrapper = {
    touchstartX: 0,
    touchstartY: 0,
    touchendX: 0,
...
const inserted = (el: HTMLElement, binding: TouchVNodeDirective, vnode: VNode) => {
...
const unbind = (el: HTMLElement, binding: TouchVNodeDirective, vnode: VNode) => {
