...
export { TYPES, T_SURVEY, T_SURVEY_TICKET, T_SURVEY_RECEPTION, T_PPR, T_CAMPAIGN_MESSAGE, T_BANNER, T_PPR_CODE, RESPONSE_ACCEPT, RESPONSE_ANSWER, RESPONSE_REFUSE, RESPONSE_PUTOFF, RESPONSE_CLICK_FOR_VIEW, RESPONSE_CLICK_TO_CLOSE_VIEW };
