...
export const TEST_SSO_CHANGE_CUSTOMER_IFRAME = 'https://sso-balancer2.testing.srv.loc/auth/admin/user/console?iframe=1&hiddenHeader=true'
export const SSO_CHANGE_CUSTOMER_IFRAME = 'https://auth.domru.ru/auth/admin/user/console/?iframe=1&hiddenHeader=true'
